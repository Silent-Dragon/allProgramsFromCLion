...
void move(int i, int j, char heading, int moves) {
    ...
    if (maze[i][j - 1] == 0 && heading == 'U') {
        ...
        move(i, j - 1, 'L', cnt);
    } else if (maze[i - 1][j] == 0 && heading == 'U') {
        maze[i][j] = 1;
        I -= 1;
        cnt++;
        ...
        move(i - 1, j, 'U', cnt);
    } else if (maze[i][j + 1] == 0 && heading == 'U') {
        maze[i][j] = 1;
        J += 1;
        cnt++;
    ...
    if (maze[i + 1][j] == 0 && heading == 'L') {
        ...
        move(i + 1, j, 'D', cnt);
    } else if (maze[i][j - 1] == 0 && heading == 'L') {
        maze[i][j] = 1;
        J -= 1;
        cnt++;
        ...
        move(i, j - 1, 'L', cnt);
    } else if (maze[i - 1][j] == 0 && heading == 'L') {
        maze[i][j] = 1;
        I -= 1;
        cnt++;
    ...
    if (maze[i - 1][j] == 0 && heading == 'R') {
        ...
        move(i - 1, j, 'U', cnt);
    } else if (maze[i][j + 1] == 0 && heading == 'R') {
        maze[i][j] = 1;
        J += 1;
        cnt++;
        ...
        move(i, j + 1, 'R', cnt);
    } else if (maze[i + 1][j] == 0 && heading == 'R') {
        maze[i][j] = 1;
        I += 1;
        cnt++;
    ...
    if (maze[i][j + 1] == 0 && heading == 'D') {
        ...
        move(i, j + 1, 'R', cnt);
    } else if (maze[i + 1][j] == 0 && heading == 'D') {
        maze[i][j] = 1;
        I += 1;
        cnt++;
        ...
        move(i + 1, j, 'D', cnt);
    } else if (maze[i][j - 1] == 0 && heading == 'D') {
        maze[i][j] = 1;
        J -= 1;
        cnt++;
